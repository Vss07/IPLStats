...
def MVP2():
    ...
    def sixes():
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by 6s DESC")
            rows=cur.fetchall()
            update(rows)

    def fours():
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%'  Order by 4s DESC")
            rows=cur.fetchall()
            update(rows)

    def wickets():
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%'  Order by wickets DESC")
            rows=cur.fetchall()
            update(rows)

    def dot():
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%'  Order by DotBalls DESC")
            rows=cur.fetchall()
            update(rows)
    ...
    def player1():
            ...
            if c==1:
                k=0
                co=[["Position", "Player","Team","Matches","Wickets","Dot Balls","Fours","Sixes","Catches","Stumpings","Run Outs","Points"]]
                op=Tk()
    ...
    def CSK():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Team LIKE '%Chennai%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def MI():
            ...
            e='Mumbai Indians'
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Team LIKE '%Mumbai%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def DC():
            ...
            e='Delhi Capitals'
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Team LIKE '%Delhi%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def KKR():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Team LIKE '%Kolkata%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def KXIP():
            ...
            e='Kings XI Punjab'
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Team LIKE '%Punjab%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def RR():
            ...
            e='Rajasthan Royals'
            ab=Ent.get()
            cur.execute("SELECT * from mvp2019 where Team LIKE '%Rajasthan%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def RCB():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Team LIKE '%Bangalore%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def SRH():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from mvp2020 where Team LIKE '%Hyderabad%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    bt=Button(w2,text="Sort by Sixes",command=sixes)
    bt.pack(side=tk.LEFT,padx=6)
    bt=Button(w2,text="Sort by Fours",command=fours)
    bt.pack(side=tk.LEFT,padx=6)
    bt=Button(w2,text="Sort by Wickets",command=wickets)
    bt.pack(side=tk.LEFT,padx=6)
    bt=Button(w2,text="Sort by DotBalls",command=dot)
    bt.pack(side=tk.LEFT,padx=6)
