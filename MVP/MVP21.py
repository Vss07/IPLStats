...
def MVP3():
    ...
    def default():
            ...
            e=''
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021")
            rows=cur.fetchall()
            update(rows)

    def sixes():
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by 6s DESC")
            rows=cur.fetchall()
            update(rows)

    def fours():
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by 4s DESC")
            rows=cur.fetchall()
            update(rows)

    def wickets():
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by wickets DESC")
            rows=cur.fetchall()
            update(rows)

    def dot():
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by DotBalls DESC")
            rows=cur.fetchall()
            update(rows)
    ...
    def player():
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Player LIKE '%"+ab+"%'")
            player1()
    ...
    def CSK():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Team LIKE '%Chennai%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def MI():
            ...
            e='Mumbai Indians'
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Team LIKE '%Mumbai%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def DC():
            ...
            e='Delhi Capitals'
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Team LIKE '%Delhi%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def KKR():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Team LIKE '%Kolkata%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def KXIP():
            ...
            e='Punjab Kings'
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Team LIKE '%Punjab%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def RR():
            ...
            e='Rajasthan Royals'
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Team LIKE '%Rajasthan%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def RCB():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Team LIKE '%Bangalore%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def SRH():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from mvp2021 where Team LIKE '%Hyderabad%'")
            rows=cur.fetchall()
            update(rows)
    ...
    but.pack(side=tk.LEFT,padx=6)
    but=Button(w3,text="Punjab Kings",command=KXIP)
    but.pack(side=tk.LEFT,padx=6)
