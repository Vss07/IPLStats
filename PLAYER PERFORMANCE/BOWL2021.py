...
def BO2021():
    ...
    def default():
            ...
            e=''
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021")
            rows=cur.fetchall()
            update(rows)

    def overs():
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by Overs DESC")
            rows=cur.fetchall()
            update(rows)

    def runs():
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by Runs DESC")
            rows=cur.fetchall()
            update(rows)

    def econ():
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by Econ DESC")
            rows=cur.fetchall()
            update(rows)

    def strate():
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by SR DESC")
            rows=cur.fetchall()
            update(rows)

    def avg():
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by Average DESC")
            rows=cur.fetchall()
            update(rows)
    ...
    def player():
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Player LIKE '%"+ab+"%'")
            player1()
    ...
    def CSK():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Team LIKE '%Chennai%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def MI():
            ...
            e='Mumbai Indians'
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Team LIKE '%Mumbai%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def DC():
            ...
            e='Delhi Capitals'
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Team LIKE '%Delhi%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def KKR():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Team LIKE '%Kolkata%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def PBKS():
            ...
            e='Punjab Kings'
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Team LIKE '%Punjab%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def RR():
            ...
            e='Rajasthan Royals'
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Team LIKE '%Rajasthan%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def RCB():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Team LIKE '%Bangalore%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def SRH():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from bowling2021 where Team LIKE '%Hyderabad%'")
            rows=cur.fetchall()
            update(rows)
