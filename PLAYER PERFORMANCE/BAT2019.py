...
def BT2019():
    ...
    def default():
            ...
            e=''
            ab=Ent.get()
            cur.execute("SELECT * from batting2019")
            rows=cur.fetchall()
            update(rows)

    def centuries():
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by Centuries DESC")
            rows=cur.fetchall()
            update(rows)

    def fifties():
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by Fifties DESC")
            rows=cur.fetchall()
            update(rows)

    def strate():
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by StrikeRate DESC")
            rows=cur.fetchall()
            update(rows)

    def avg():
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Player LIKE '%"+ab+"%' and Team LIKE '%"+e+"%' Order by Average DESC")
            rows=cur.fetchall()
            update(rows)
    ...
    def player():
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Player LIKE '%"+ab+"%'")
            player1()
    ...
    def CSK():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Team LIKE '%Chennai%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def MI():
            ...
            e='Mumbai Indians'
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Team LIKE '%Mumbai%'and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def DC():
            ...
            e='Delhi Capitals'
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Team LIKE '%Delhi%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def KKR():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Team LIKE '%Kolkata%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def KXIP():
            ...
            e='Kings XI Punjab'
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Team LIKE '%Punjab%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def RR():
            ...
            e='Rajasthan Royals'
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Team LIKE '%Rajasthan%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def RCB():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Team LIKE '%Bangalore%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
    ...
    def SRH():
            ...
            ab=Ent.get()
            cur.execute("SELECT * from batting2019 where Team LIKE '%Hyderabad%' and Player LIKE '%"+ab+"%'")
            rows=cur.fetchall()
            update(rows)
